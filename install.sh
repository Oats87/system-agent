...
markerDirectory: ${CATTLE_AGENT_VAR_DIR}/markers
...
do_install() {
    ...
    touch ${CATTLE_AGENT_VAR_DIR}/markers/restart-pending
    ensure_applyinator_not_active
    ...
    rm -f ${CATTLE_AGENT_VAR_DIR}/markers/restart-pending
}
